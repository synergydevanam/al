        ...
        <asp:GridView ID="gvLogin" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                <asp:TemplateField HeaderText="Select">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbSelect" runat="server" CommandArgument='<%#Eval("LoginID") %>'
                            OnClick="lbSelect_Click">
                            Profile
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <%--<asp:TemplateField HeaderText="Financial data">
                    <ItemTemplate>
                        <a href='../PM/FinancialData.aspx?LoginID=<%#Eval("LoginID") %>'>Financial Data
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>--%>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbDelete" runat="server" CommandArgument='<%#Eval("LoginID") %>'
